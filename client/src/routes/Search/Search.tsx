...
import {
  ...
  TypeSearch,
  listResources,
  getTypeSearchChangeName,
  getTypeSearchChangeTheme,
  getTypeSearchChangeDate,
  getTypeSearchChangeActual,
} from "./utils";
...
export const Search: FC = () => {
  ...
  const changeTypeSearch = (e: any) => {
    ...
    if (idChange === "name") {
      ...
      typeSrch = getTypeSearchChangeActual();
    }
        ...
        <div className="block-left">
          ...
          <InputGroup className="mb-3">
            <select
              ...
              value={themes}
              onChange={(event) => setThemes(parseInt(event.target.value))}
            >
